...
install_rrdtool() {
        ...
        mkdir -p /rrdtool/ && rm -rf /rrdtool/*
                ...
                tar xf $dir_path/container-files/packages/rrdtool/rrdtool*.tar.gz -C /rrdtool --strip-components=1
                cd /rrdtool/
...
install_cacti() {
        log "### ### Install cacti"
                ...
                tar xf $dir_path/container-files/packages/cacti/cacti*.tar.gz -C /cacti --strip-components=1
        }
...
install_spine() {
        log "### ### Install spine"
                ...
                tar xf $dir_path/container-files/packages/spine/cacti-spine*.tar.gz -C /spine --strip-components=1
